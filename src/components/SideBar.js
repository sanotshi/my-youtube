  ...
  return (
    <div className="shadow-lg px-2  pr-16 cursor-pointer">
      ...
      <div className="flex pl-2">
        ...
        <div className="flex ">
          <li className="px-2"><MovieIcon /> </li>
        <li className="py-1 pl-2">Movies</li>
        </div>
        <div className="flex">
          <li className="px-2 "><SensorsIcon /></li>
        <li className="py-1 pl-2">Live</li>
        </div>
        <div className="flex">
          <li className="px-2"><SportsEsportsIcon /></li>
        <li className="py-1 pl-2">Gaming</li>
        </div>
        <div className="flex">
          <li className="px-2 "><NewspaperIcon /></li>
        <li className="py-1 pl-2">News</li>
        </div>
        <div className="flex">
          <li className="px-2"><EmojiEventsIcon /></li>
        <li className="py-1 pl-2">Sports</li>
        </div>
        <div className="flex">
          <li className="px-2"><LocalLibraryIcon /></li>
