...
const LiveChat = () => {
  ...
  return (
    <>
      <div className="ml-2 p-2 border border-black h-[700px] md:h-[750px]  md:w-auto bg-zinc-200 rounded-lg overflow-y-scroll flex flex-col-reverse">
      ...
      >
        <input
          type="text"
          className="p-1 border border-black w-56 md:w-96"
          value={liveMessage}
          onChange={(e) => {
